...
# add model
def load_model():
    with open('hcm_room_price_prediction_model_linearreg.pickle', 'rb') as f:
        model = pickle.load(f)
    return model 
...
def show_predict_page():
    ...
    st.markdown('This estimator actually improved the calculation of price compared to random forest')
